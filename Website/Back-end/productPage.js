        ...
        .then(data => {
            ...
            productPage += `
                ...
                <div class=" main_left_secimg">
                    <img class="img" src="img/${data[localStorage.productPage].img1}" alt="cat-1" />
                    <img class="img" src="img/${data[localStorage.productPage].img2}" alt="cat-1" />
                    <img class="img" src="img/${data[localStorage.productPage].img3}" alt="cat-1" />
                    <img class="img" src="img/${data[localStorage.productPage].img4}" alt="cat-1" />
                </div>
            </div>
